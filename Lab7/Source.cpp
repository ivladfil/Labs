...
int chooseMainMenu() {
	...
	while (true)
	{
		...
		if (choose_menu == 1) cout << "-> Посмотреть время" << endl;
		else cout << " Посмотреть время" << endl;

		if (choose_menu == 2) cout << " -> Определить после полудня или до полудня время" << endl;
		else cout << " Определить после полудня или до полудня время" << endl;
